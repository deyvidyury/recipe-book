...
var recipes = (typeof localStorage["recipeBook"] != "undefined") ? JSON.parse(localStorage["recipeBook"]) : [
  {title: "Spaghetti", ingredients: ["Macarrão", "Molho de tomate", "Queijo ralado"]}, 
  {title: "Lasanha", ingredients: ["Macarrão para lasanha", "Mussarela", "Presunto","Carne moida"]}
    ...
    return (
      <div>
        ...
        <Modal show={this.state.showModal} onHide={this.close}>
          ...
          <Modal.Body>
            <form>
              <input className="form-control" type="text" label="Recipe" placeholder="Recipe Name" id="title" /><br />
              <input className="form-control" type="textarea" label="Ingredients" placeholder="Enter Ingredients Separated By Commas" id="ingredients"/>
            </form>
          </Modal.Body>
          <Modal.Footer>
